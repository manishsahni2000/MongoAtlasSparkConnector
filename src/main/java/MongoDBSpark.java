...
import com.mongodb.spark_examples.Character;
...
public final class MongoDBSpark {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        writeOverrides.put("collection", "sample_mflix.spark");
        ...
        readOverrides.put("collection", "sample_mflix.spark");
        ...
        System.out.println("CUSTOM READ is "+customRdd.first().toJson());
    ...
    private static JavaSparkContext createJavaSparkContext(final String[] args) {
        System.out.println("URI is "+args[0]);
